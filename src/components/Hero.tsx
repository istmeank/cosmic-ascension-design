      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8 animate-float">
          <div className="relative inline-block">
            <img src="/logo-level-up.svg" alt="LEVEL UP for Ladies & Gentlemen" className="w-24 h-24 md:w-32 md:h-32 mx-auto mb-6 filter drop-shadow-[0_0_20px_hsl(var(--cosmic-stellar-gold)/0.8)]" />
