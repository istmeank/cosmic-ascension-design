          ...
          <div className="relative w-80 h-80 md:w-96 md:h-96 mb-8 md:mb-10 -mt-32">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              <img 
                ...
                className="w-full h-full object-contain relative z-10 drop-shadow-[0_0_25px_hsl(var(--cosmic-stellar-gold)/0.7)] hover:drop-shadow-[0_0_35px_hsl(var(--cosmic-stellar-gold)/0.9)] transition-all duration-500"
              />
            </div>
